<?php
  ...
  if(isset($_POST['register']))
  {
    ...
    $registerQuery="INSERT INTO users(fname,lname,email,password,mno,education,profession,height,age,
										...
										address,city,state,pincode,expectations,relativeSurname,fcontact)
	 VALUES('".$fname."','".$lname."','".$email."','".$pass."','".$mno."','".$education."','".$profession."','".$height."','".$age."','".$dob."','
	 ".$gender."','".$maritalStatus."','".$fatherName."','".$motherName."','".$address."','".$city."','".$state."','".$pincode."','
	 ".$expectations."','".$rsurname."','".$fcontact."')";
